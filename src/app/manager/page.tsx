...
const ManagerPage = () => {
  ...
  // Prepare last 7 days array of Date objects
  ...
  // Initialize hours per day map with 0
  ...
  // Total staff count (you may want to fetch this explicitly)
  // For demo: assuming careWorkers list contains all staff you want to count
...
//   if (anyLoading) return <p>Loading data...</p>;
//   if (anyError) {
//     return (
//       <div>
//         <p>Error loading data.</p>
